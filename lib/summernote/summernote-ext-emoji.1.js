(function (factory) {
    ...
    $.extend($.summernote.plugins, {
        'emoji': function (context) {
            ...
            var emojis = ['smile', 'laughing', 'blush', 'joy', 'smiley', 'stuck_out_tongue_closed_eyes',
            'smirk', 'heart_eyes', 'sob', 'sweat_smile', 'kissing_closed_eyes', 'flushed',
            'relieved', 'satisfied', 'grin', 'wink', 'stuck_out_tongue_winking_eye', 'grinning',
            'kissing', 'kissing_smiling_eyes', 'stuck_out_tongue', 'sleeping', 'anguished', 'open_mouth'];
