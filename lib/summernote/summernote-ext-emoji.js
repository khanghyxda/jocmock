(function (factory) {
    ...
    $.extend($.summernote.plugins, {
        'emoji': function (context) {
            ...
            var emojis = ['angry', 'anguished', 'blush', 'cold_sweat', 'confounded', 'confused',
            'disappointed', 'disappointed_relieved', 'dizzy_face', 'flushed', 'grimacing', 'grin',
            'grinning', 'hushed', 'laughing', 'open_mouth', 'satisfied', 'sleeping',
            'sleepy', 'smile', 'smiley', 'smirk', 'sweat_smile', 'wink'];
            ...
            var addListener = function () {
                ...
                $(document).on('click', '.selectEmoji', function(){
                    var img = new Image();
                    img.src = 'lib/pngs/'+$(this).attr('data-value')+'.png';
            ...
            var render = function (emojis) {
                ...
                var emojis = emojis;
				emoList += '<div class="d-flex flex-wrap justify-content-between">';
            ...
            context.memo('button.emoji', function () {
                ...
                var button = ui.button({
                    contents: '<i class="far fa-smile" style="font-size: .875rem;line-height: 1.5"/>',
                    //tooltip: 'emoji',
                    click: function () {
            ...
            this.initialize = function () {
                this.$panel = $('<div class="modal"  role="dialog" id="emoji-dropdown">' +
